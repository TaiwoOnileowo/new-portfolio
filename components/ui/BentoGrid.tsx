...
export const BentoGridItem = ({
  ...
  const rightLists = ["Framer", "TailwindCSS", "WordPress"];
  ...
  const handleCopy = () => {
    ...
    const text = "taiwoonileowo17@gmail.com";
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              {/* tech stack lists */}
              <div className="flex flex-col gap-3 mt-[40px] md:gap-3 lg:gap-8">
              ...
              <div className="flex flex-col gap-3 mb-[40px]  md:gap-3 lg:gap-8">
